...
let VanillaCalendar = (function () {
    function VanillaCalendar(options) {
        ...
        if (!element) return
        const getWeekDay = day =>  ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'][day]
        ...
        const createDay = function (date) {
            ...
            if (date.getDate() === 1) newDayElem.style.marginLeft = ((date.getDay()) * 14.28) + '%'
            ...
            if (date.toString() === opts.todaysDate.toString()) newDayElem.classList.add('vanilla-calendar-date--today')
