...
<form id="customerform" class="clientform">
    <div class="contact">
        ...
        <input class="inputbasic" id="eventname" name="eventname" placeholder="Event Name" type="text">
...
<div class="backgroundcover popupitem">
    <div class="accountlistcontainer popupitem">
        <div class="close">X</div>
        <div id="accountlist"></div>
    </div>
    <div id="schedulepopup" class="popupitem">
        <div class="close">X</div>
        <!-- <div class="calendar-container" id="calendar"></div> -->
        <div id="schedulecontent"></div>
        <select name="type_id" id="type_id">
            <option value="30" selected>New Activation</option>
            <option value="34">Site Survey</option>
        </select>
        <button type="button" class="btn" id="schedulesubmit">Schedule Appointment</button>
    </div>
    <div class="agilelogin popupitem">
        <input name="username" id="username" class="agileuser" placeholder="Username">
        <input name="password" id="password" class="agileuser" type="password" placeholder="Password">
        <button type="button" class="btn" id="getagiletoken">Submit</button>
    </div>
    <div id="loader" class="popupitem"></div>
</div>