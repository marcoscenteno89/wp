...
<section class="container-fluid header-parent" style="padding:0;">
  ...
  <div class="header-con container flex-center" style="justify-content:flex-end;">
    <div class="flex-col" style="align-items:center;">
      ...
      <a href="#sidebar" class="btn cta">Get Connected for FREE*</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li><a href="#plans" class="font-blue">Plans</a></li>
        <li><a href="/status/" class="font-blue">Construction Updates</a></li>
      </ul>
    </div>
  </div>
</nav>
<article class="container">
  ...
  <section class="row main-con" style="padding-top:4rem;">
    <div class="col-8"  id="anthemDifference">
      <div class="row">
        <div class="col-10">
          ...
          <p>Anthem broadband utilizes redundant paths and multiple servers. So, if one line goes  down, your service is automatically rerouted to another line, and you don’t lose connection. At Anthem, we even take this a step further by also including redundant local service paths in town.</p>
          <br>
          <h2 id="plans">Plans/Pricing</h2>
          <p>Others may offer lower upfront pricing, but read the fine print - there’s a lot of it! Your price will go up after the promotional period. You’ll have to “rent” your router for an extra monthly cost, and you’ll pay extra per month for managed Wi-Fi. Put plainly, the monthly price advertised is not the price you will pay. Our pricing is upfront, honest and all-inclusive.</p>
        </div>
      </div>
    </div>
    <div class="col-4 row" style="justify-content:flex-end;">
      <div class="col-10 sidebar" id="sidebar">
        ...
        <div style="color:#FFF;text-align:center;padding:1rem 0;">
          <h4 style="color:#FFF;">Got Questions?</h4>
          <h5 style="color:#FFF;">We've got answers</h5>
          <a href="tel:+17753892894"><h2 style="color:#FFF;">775.389.2894</h2></a>
        </div>
        <ul>
          <li><strong>NO</strong> construction fee</li>
          <li><strong>NO</strong> installation fee</li>
          <li><strong>NO</strong> activation fee</li>
          <li><strong>NO</strong> contracts</li>
          <li><strong>NO</strong> data limits</li>
          <li><strong>NO</strong> throttling</li>
          <li><strong>NO</strong> credit check</li>
          <li><strong>NO</strong> equipment rental</li>
        </ul>
      </div>
    </div>
  </section>
  <section class="row">
    <div class="col-12">
      <div class="row alert-secondary">
        <div class="col-6">
          <div class="col-12" style="padding:1rem 0 1rem 0;">
            <div class="row cta" style="padding:1rem;border-radius:0.5rem;box-shadow: 0 0 15px rgba(0,0,0,.5);align-items:center;">
              <div class="col-8" style="font-size:1.3rem;font-weight:600;line-height:1.2;">Connection to fiber network</div>
              <div class="col-4" style="font-size:2.5rem;font-weight:600;">FREE</div>
            </div>
          </div>
        ...
        <div class="col-12 row" style="background-color:#009bab;color:#fff;padding:1rem;align-items:center;">
          ...
          <div class="col-3"><a href="#sidebar" class="cta btn">Hook me up!</a></div>
        </div>
      </div>
    </div>
  </section>
